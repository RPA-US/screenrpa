...
def detect_separator(file_path):
    ...
    if "," in first_line and ";" in first_line:
        raise ValueError(
            "Ambos separadores ',' y ';' están presentes en la primera línea. No se puede determinar el separador automáticamente."
        )
    elif "," in first_line:
        separator = ","
    elif ";" in first_line:
        ...
        raise ValueError(
            "No se pudo determinar el separador. Asegúrese de que el archivo tenga un separador ',' o ';'."
        )
...
def read_ui_log_as_dataframe(log_path, nrows=None, ncols=None, lib="pandas"):
    ...
    match lib:
        ...
        case _:
            raise ValueError(
                "La librería especificada no es válida. Las opciones válidas son 'pandas' y 'polars'."
            )

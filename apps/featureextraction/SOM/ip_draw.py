...
COLOR = {'Button': (0, 255, 0), 'CheckBox': (0, 0, 255), 'Chronometer': (255, 166, 166),
                      'EditText': (255, 166, 0),
...
def draw_bounding_box_class(org, components, color_map=COLOR, line=2, show=False, write_path=None, name='board'):
    """

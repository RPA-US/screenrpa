...
urlpatterns = [
    ...
    path('noise-filtering/list/', views.NoiseFilteringListView.as_view(), name='gaze_fixation_list'),
    path('noise-filtering/new/', views.NoiseFilteringCreateView.as_view(), name='gaze_fixation_create'),

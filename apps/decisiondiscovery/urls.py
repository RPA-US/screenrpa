...
urlpatterns = [
    ...
    path('ex/extract-training-dataset/detail/<int:execution_id>/<int:extract_training_dataset_id>/', views.ExtractTrainingDatasetDetailView.as_view(), name='extract_training_dataset_detail-execution'),

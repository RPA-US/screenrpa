...
urlpatterns = [
    ...
    path('decision-tree-training/detail/<int:case_study_id>/<int:ui_element_detection_id>/', views.DecisionTreeTrainingDetailView.as_view(), name='decision_tree_training_detail'),

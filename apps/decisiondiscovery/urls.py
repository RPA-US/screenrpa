...
urlpatterns = [
    ...
    path('ex/decision-tree-training/detail/<int:execution_id>/<int:decision_tree_training_id>/', views.DecisionTreeTrainingDetailView.as_view(), name='decision_tree_training_details_ex'),

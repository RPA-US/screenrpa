...
class ProcessDiscoveryForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "show_dendrogram": forms.CheckboxInput(
                attrs={"class": "custom-control-input"}
            ),
            "remove_loops": forms.CheckboxInput(
                attrs={"class": "custom-control-input"}
            ),
    ...
    def __init__(self, *args, **kwargs):
        ...
        if case_study_instance is not None:
            ...
            text_column_choices = [
                (value, key) for key, value in special_colnames.items()
            ]
            text_column_choices.append((_("Top Level Text"), "Top Level Text"))

...
def CART_sklearn_decision_tree(df, param_path, implementation, graphical_representation, target_label='Variant'):
    times = {}
    # Training set
...
def chefboost_decision_tree(df, param_path, algorithms, graphical_representation, target_label):
    """
    ...
    :param config: Dict that corresponds to the Chefboost fitting configuration
    :type config: dict
